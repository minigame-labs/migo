//! Q13 parallel GPU/V8 startup contract guards.
//!
//! These source checks run standalone to avoid the host EGL/Skia link:
//! `rustc --edition 2024 --test crates/core/runtime/tests_q13_contract.rs`.
...
mod q13_contract {
    ...
    const RENDER_THREAD: &str = include_str!("../../graphics/render_thread.rs");
    const CANVAS_MANAGER: &str = include_str!("../../graphics/canvas/manager/mod.rs");
    const GPU_CAPS: &str = include_str!("../../shared/device/gpu_caps.rs");
