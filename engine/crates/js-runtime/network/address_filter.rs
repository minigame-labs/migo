...
//!
//! Blocks connections to private/loopback/link-local addresses to prevent
//! game JS from accessing internal services, cloud metadata endpoints,
//! or localhost resources.
