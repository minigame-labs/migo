...
// https://utility.spec.whatwg.org/#idl-DOMException
...
class DOMException {
  ...
  constructor(message = "", name = "Error") {
    message = utility.converters.DOMString(
      message,
      "Failed to construct 'DOMException'",
      "Argument 1",
    );
    name = utility.converters.DOMString(
      name,
      "Failed to construct 'DOMException'",
      "Argument 2",
    );
...
utility.configureInterface(DOMException);
