...
import com.minigame.host.internal.jni.MotionEventFlattener;
...
public final class HostHandle {
    ...
    public boolean startGame(String codeDir, String entry) {
        ensureNotDestroyed();
        return HostNative.startGame(hostId, codeDir, entry) == 0;
    }
    ...
    public void onTouch(MotionEvent e) {
        ...
        HostNative.dispatchTouchEvent(hostId, e.getActionMasked(), e.getEventTime(), pointerCount, touchBuffer);
    }
