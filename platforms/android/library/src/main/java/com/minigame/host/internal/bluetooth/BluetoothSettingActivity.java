package com.minigame.host.internal.bluetooth;
...
public class BluetoothSettingActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (intent != null) {
            hostId = intent.getIntExtra("com.minigame.host.EXTRA_HOST_ID", -1);
            if (hostId == -1) {
    ...
    private void onFinish(int code) {
        HostNative.onOpenSystemBluetoothSetting(hostId, code);
        finish();
    }
}
