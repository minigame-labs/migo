...
/**
 * The channel a {@link SettingHandler} settles {@code migo.openSetting()} on.
 * <p>
...
public interface SettingSink {
     ...
     * keyed by platform scope name ({@code "scope.camera"}). The runtime does not store
     ...
     * {@code migo.getSetting()} reads that rather than this. Report a grant here
     ...
     * with the field absent: the common mini-game platform always carries it on a success, and content reads
